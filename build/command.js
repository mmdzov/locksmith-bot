...
var Commands = /** @class */ (function () {
    ...
    Commands.prototype.newbot = function () {
        ...
        bot_1.default.command("newbot", function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            var TOKEN_1, datas, tokens, index, b;
            var _a, _b, _c, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!(((_b = (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.text) === null || _b === void 0 ? void 0 : _b.trim()) !== "/newbot")) return [3 /*break*/, 3];
                        ...
                        datas = fs_1.default.readFileSync("src/data/tokens.json", "utf8");
                        tokens = JSON.parse(datas);
                        index = tokens.findIndex(function (token) { return token === TOKEN_1; });
                    ...
                    case 1:
                        _f.sent();
                        fs_1.default.writeFileSync("src/data/tokens.json", JSON.stringify(tokens));
                        b.start();
                        bot_1.default.api.sendMessage((_e = ctx.from) === null || _e === void 0 ? void 0 : _e.id, "\u0631\u0628\u0627\u062A \u0634\u0645\u0627 \u0628\u0627 \u0622\u06CC\u062F\u06CC @" + b.botInfo.username + " \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u0633\u0627\u062E\u062A\u0647 \u0634\u062F \u0648\u0627\u0631\u062F\u0634 \u0634\u0648\u06CC\u062F \u0648 /start \u0628\u0632\u0646\u06CC\u062F.");
                        return [3 /*break*/, 2];
                    case 2: 
                    // b.api
